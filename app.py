        ...
        for line in content.split('\n'):
            ...
            if line.startswith('Slide'):
                ...
                if "Title" in line:
                    ...
                    title_shape.text_frame.paragraphs[0].font.color.rgb = (255, 255, 255) 
...
def generate_mindmap(summary_text, llm):
    ...
    try:
        ...
        * Sub-branch 2.2
        ...
        colors = {
            'central': '#FF6B6B',  
            'branches': ['#4ECDC4', '#45B7D1', '#A5D8D1', '#7FB3D5'],  
            'sub': ['#FFE66D', '#FFD166', '#F7C1BB']  
        }
        ...
        for line in structure.split('\n'):
            ...
            if line.startswith('#'):
                central_node = line[1:].strip().split()[0] 
